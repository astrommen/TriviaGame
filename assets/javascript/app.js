$(document).ready(function() {
    ...
    var questions = [
        { q: "Which house was Harry Potter sorted into?", 
            ...
            correct: "Gryffindor", 
            img: "https://www.bing.com/th/id/OIP.T74hl6yd9lFGbTRZvgxHbgHaJl?w=170&h=220&c=7&o=5&pid=1.7"},
        { q: "What is the name of the Harry's Wizard School?", 
            a: ["Beauxbatons", "Hogwarts", "Ilvermorny", "Durmstrang"],
            correct: "Hogwarts",
            img: "http://cdn4.tillthemoneyrunsout.com/wp-content/uploads/2015/11/Hogwarts-Castle-as-Seen-from-Dragon-Challenge-Line-Visiting-Harry-Potter-World-Orlando1-980x653.jpg"},
        { q: "Who is Harry's godfather?", 
            a: ["Sirius Black", "Severus Snape", "Michael Corleone", "Albus Dumbledore"],
            correct: "Sirius Black",
            img: "https://www.bing.com/th/id/OIP.ox1jAApUxSRAGc4jTocO-QHaJk?w=201&h=261&c=7&o=5&pid=1.7"},
        {q: "What position did Harry play in Quidditch?",
            a: ["Beater", "Keeper", "Seeker", "Chaser"],
            correct: "Seeker",
            img: "https://www.bing.com/th/id/OIP.WsXEFd7WhIHA4sL_80z1YwHaGl?w=202&h=176&c=7&o=5&pid=1.7"},
        {q: "What Hogwarts House did everyone hate?",
            a: ["Hufflepuff", "Ravenclaw", "Gryffindor", "Slytherin"],
            correct: "Slytherin",
            img: "https://www.bing.com/th/id/OIP.hY9yWy3Z9lR8HlzsLrn27wHaHa?w=192&h=186&c=7&o=5&pid=1.7"},
        {q: "Who was Harry Potter's nemesis?",
            a: ["Grindlewald", "Voldemort", "Knights of Nee", "Beedle the Bard"],
            correct: "Voldemort",
            img: "https://www.bing.com/th/id/OIP.0QQ_4FXNxGIWQoL4v_l3XgHaEK?w=251&h=160&c=7&o=5&pid=1.7"}
    ];
    ...
    function run() { //full timer function
        count = 31; //reset html count to 30 each time
